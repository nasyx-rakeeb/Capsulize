...
const Bio = ({navigation}) => {
  const {bio, setBio, handleBtnPress, notes, noteConditionMet, areAllConditionsMet} = useBio(navigation)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        <TextInput numberOfLines={4} multiline onChangeText={setBio} value={bio} left={<TextInput.Icon icon="information-outline"/>} style={styles.input} label="Bio (optional)" mode="flat" />
      </View>
